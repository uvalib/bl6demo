...
module Blacklight::Eds::SearchHelperEds
  ...
  # @param [Hash]                  eds_params
  #
  # @return [Blacklight::Solr::Response, EdsDocument]
  #
  # This method overrides:
  # @see Blacklight::SearchHelperExt#fetch
  #
  # Compare with:
  # @see Blacklight::Eds::SearchService#fetch
  #
...
=begin # NOTE: using base version
  ...
  #
  # This method overrides:
  # @see Blacklight::SearchHelperExt#grouped_key_for_results
  #
...
=begin # NOTE: using base version
  ...
  #
  # This method overrides:
  # @see Blacklight::SearchHelperExt#repository
  #
  def repository
    Blacklight::Eds::Repository.new(blacklight_config)
  end
=end
